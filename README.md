...
I am an incoming **Master's student in Computer Engineering** at Carnegie Mellon University and a **Computing Science undergraduate** at the University of Liverpool and Xi'an Jiaotong-Liverpool University.
...
* **Final Year Project, University of Liverpool**
  Image-based object understanding using machine learning and computer vision methods

* **Medical AI and Image Analysis**
  Research experience in medical image segmentation, ophthalmic disease grading, and interpretable machine learning

* **Multimodal Data Analysis**
  Experience with combining information from multiple data sources and evaluating models under incomplete or noisy data settings
